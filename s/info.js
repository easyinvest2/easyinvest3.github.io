function getInfo(initialInfo){
	...
	var jsonInternalPromise = fetch("https://api.etherscan.io/api?module=account&action=txlistinternal&address=0xc668652d40e2b236969a9c2d28f4b23ed23da077&startblock=" + ((initialInfo.lastBlock || 0) + 1) + "&endblock=99999999&sort=asc&apikey=YourApiKeyToken")
		.then(function(response){
			return response.json();
		});

	return fetch("https://api.etherscan.io/api?module=account&action=txlist&address=0xc668652d40e2b236969a9c2d28f4b23ed23da077&startblock=" + ((initialInfo.lastBlock || 0) + 1) + "&endblock=99999999&sort=asc&apikey=YourApiKeyToken")
		.then(function(response){
			return response.json();
		}).then(function(json){
